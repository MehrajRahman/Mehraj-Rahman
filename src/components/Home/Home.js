...
const Home = () => {
  ...
  const { freq, factor, scale, opacity } = useSpring({
    reverse: open,
    from: { factor: 10, opacity: 0.4, scale: 0.05, freq: "0.0175, 0.0" },
...
{/*      
      ...
      <img className="main-img" height="250px" src={img} alt=""/>
      <div className="overlay overlay-bottom"></div>
   
      </div>
      <h1 className="home-tag">Hello, I am Mehraj Rahman </h1>
      <h2 className="tag-line">Mern Stack Developer</h2>
    </div>
    <About></About>
    <Projects></Projects>
    <Contact></Contact>
